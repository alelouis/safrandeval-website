...
document.getElementById("selection_creationsalees").style.textDecoration = "underline";

document.querySelector(".open-biscuits_chorizo").addEventListener("click", function () {
    document.querySelector(".modal-title").innerHTML = "Biscuits chorizo safran - 100g";
    document.querySelector(".modal-description").innerHTML = "Chorizo artisanal, farine de blé, flocons d’avoine, beurre doux, sel de Guérande, eau, Emmental, safran, herbe de Provence.";
    document.querySelector(".modal-price").innerHTML = "4,50€ TTC";
    modal.classList.remove("hidden");
            overlay.classList.remove("hidden");
        });

document.querySelector(".open-tuiles_tomate").addEventListener("click", function () {
    document.querySelector(".modal-title").innerHTML = "Tuiles tomate safran - 100g";
    document.querySelector(".modal-description").innerHTML = "Tomates séchées, farine de blé Bio, beurre doux, oeufs Bio, sel de Guérande, sésame, piment de Cayenne, safran.";
    document.querySelector(".modal-price").innerHTML = "4,50€ TTC";
    modal.classList.remove("hidden");
            overlay.classList.remove("hidden");
        });
